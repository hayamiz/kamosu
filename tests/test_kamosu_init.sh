...
assert_file_contains "${KB_DIR}/docker-compose.yml" ".claude-host:ro" "OAuth docker-compose.yml mounts Claude credentials"
assert_file_exists "${KB_DIR}/.gitignore"
assert_file_exists "${KB_DIR}/.kamosu-config"
assert_file_exists "${KB_DIR}/.kamosu-config.example"
assert_file_exists "${KB_DIR}/.kamosu-version"
